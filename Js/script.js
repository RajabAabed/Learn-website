$(document).ready(function () {
    ...
    $(".c-view:nth-child(4) .show-d-coures-t").addClass("left-show");
    $(".c-view:nth-child(8) .show-d-coures-t").addClass("left-show");
    $(".c-view:nth-child(12) .show-d-coures-t").addClass("left-show");
    $(".c-view:nth-child(16) .show-d-coures-t").addClass("left-show");
    $(".c-view:nth-child(20) .show-d-coures-t").addClass("left-show");
    $(".c-view .show-d-coures-t").addClass("show-d-coures");

    $(".c-col4").click(function () {
        $(this).children(".c-view").removeClass("col-md-4");
        ...
        $(".main-course-content-b .card-body").removeClass("pr-0");
        ...
        $(".c-view:nth-child(3) .show-d-coures-t").removeClass("left-show-3");
        $(".c-view:nth-child(6) .show-d-coures-t").removeClass("left-show-3");
        $(".c-view:nth-child(9) .show-d-coures-t").removeClass("left-show-3");
        $(".c-view:nth-child(12) .show-d-coures-t").removeClass("left-show-3");
        $(".c-view:nth-child(15) .show-d-coures-t").removeClass("left-show-3");
    ...
    $(".c-col3").click(function () {
        ...
        $(".show-d-coures-t").removeClass("show-show-js");
        $(".c-view:nth-child(4) .show-d-coures-t").removeClass("left-show");
        $(".c-view:nth-child(8) .show-d-coures-t").removeClass("left-show");
        $(".c-view:nth-child(12) .show-d-coures-t").removeClass("left-show");
        $(".c-view:nth-child(16) .show-d-coures-t").removeClass("left-show");
        $(".c-view:nth-child(20) .show-d-coures-t").removeClass("left-show");

        $(".c-view:nth-child(3) .show-d-coures-t").addClass("left-show-3");
        $(".c-view:nth-child(6) .show-d-coures-t").addClass("left-show-3");
        $(".c-view:nth-child(9) .show-d-coures-t").addClass("left-show-3");
        $(".c-view:nth-child(12) .show-d-coures-t").addClass("left-show-3");
        $(".c-view:nth-child(15) .show-d-coures-t").addClass("left-show-3");
    ...
    $(".c-col1").click(function () {
        ...
        $(".main-course-content-b .card-body").addClass("pr-0");
    ...
    $(".btn-show-course").click(function () {
        if ($(".btn-show-course").text() == "Hide List") {
        ...
        } else if ($(".btn-show-course").text() == "Show List") {
